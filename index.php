                                ...
                                <fieldset>
                                  ...
                                  <div class="form-group">
                                      <div class="col-md-6">
                                        ...
                                        <input name="celular" class="form-control" placeholder="Tu apellido" type="text">
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-6">
                                        ...
                                        <input name="cuenta" class="form-control" placeholder="codynamico@gmail.com" type="text">
                                      </div>
                                    </div>
